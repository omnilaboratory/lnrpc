...
export namespace ListUnspentResponse {
  export type AsObject = {
    utxosList: Array<lightning_pb.Utxo.AsObject>,
  }
}
...
export namespace ImportAccountResponse {
  export type AsObject = {
    ...
    dryRunExternalAddrsList: Array<string>,
    dryRunInternalAddrsList: Array<string>,
  }
}
...
export namespace FundPsbtResponse {
  export type AsObject = {
    ...
    lockedUtxosList: Array<UtxoLease.AsObject>,
  }
}
...
export namespace TxTemplate {
  export type AsObject = {
    inputsList: Array<lightning_pb.OutPoint.AsObject>,
    outputsMap: Array<[string, number]>,
  }
}
...
export interface AddressTypeMap {
  ...
  PUBKEYHASH: 3;
  HYBRID_NESTED_WITNESS_PUBKEY_HASH: 4;
}
